...
/**
 * Represents a meter read, corresponds to RecordType 200 in SimpleNem12 The volumes property is a
 * map that holds the date and associated <code>MeterVolume</code> on that date, values come from
 * RecordType 300.
 */
